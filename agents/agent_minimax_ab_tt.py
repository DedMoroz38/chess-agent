...
class TTEntry:
    ...
    depth: int
    value: float
    flag: int  # TT_EXACT, TT_LOWER, or TT_UPPER
    age: int  # Search generation for aging
...
class AlphaBetaAgent:
    def __init__(self, max_depth: int = 4, evaluator: Optional[BoardEvaluator] = None, table_size: int = 100_000):
    ...
    def choose(self, board, player):
        self.reset_stats()
        self.search_age += 1  # Increment age instead of clearing TT
